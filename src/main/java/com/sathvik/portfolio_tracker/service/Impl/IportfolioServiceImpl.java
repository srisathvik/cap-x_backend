...
public class IportfolioServiceImpl implements IportfolioService {
    ...
    public PortfolioResponseDto getPortfolio(String email) {
        ...
        for (StockPortfolioDto stock : stockPortfolioDto) {
            ...
            currentValue = currentValue.add((alphavantageService.getStockPrice(stock.getTicker())).multiply(BigDecimal.valueOf(stock.getQuantity())));
        }
    ...
    @Override
    public void addStock(StockAddDto stockDto) {
